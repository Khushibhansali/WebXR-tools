...
$(document).ready(function () {
    ...
    $("#main").append('<a-plane id="noise-vr" material="transparent:true;opacity:0" width="100" height="100" position="0 0 ' + distanceFromEyes + '"></a-plane>');
    ...
    $("#distance2").change(function () {
        distanceFromEyes = parseFloat($("#distance2").val());
    });
